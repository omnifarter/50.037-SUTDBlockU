        ...
        <div className="card px-5 py-5 w-full">
            <div className="flex">
                ...
                <div className='ml-5'>
                    ...
                    <Text variant='h1' className="font-bold text-4xl mt-2">{props.NFT.listed ? props.NFT.price + " ETH" : "Not Listed" }</Text>
            ...
            {!props.NFT.listed && <Button style={{width:'100%'}} onClick={onClickList}>List now</Button>}
        </div>
    );
}
